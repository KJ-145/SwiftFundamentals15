...
favouriteBook.title = "The Purpose Driven Life"
favouriteBook.author = "Rick Warren"
favouriteBook.pages = 368
favouriteBook.price = 12

print(" \(favouriteBook.title) book, written by \(favouriteBook.author), has \(favouriteBook.pages) pages and it only costs $\(favouriteBook.price).")
