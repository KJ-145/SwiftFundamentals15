...
var Joshua = User(userName: "Joshua", age: 19, height: 180, weight: 150, activityLevel: 3)
print(Joshua.userName)
print(Joshua.age)
print(Joshua.height)
print(Joshua.weight)
print(Joshua.activityLevel)
/*:
